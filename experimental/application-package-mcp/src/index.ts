...
const PUBLIC_MCP_URL = "https://jobmcp.pmlecuong.com/mcp";
...
<div class="page">
  ...
  <main class="hero">
    <div>
      ...
      <div class="connection">Connection address for your AI app:<br><code>${PUBLIC_MCP_URL}</code></div>
    </div>
...
@media (max-width:850px) { .hero { min-height:auto; grid-template-columns:1fr; padding-top:36px; } .hero-visual { min-height:360px; } .features { grid-template-columns:1fr 1fr; } .comparison-layout,.letter-example { grid-template-columns:1fr; gap:30px; } .simple-flow { grid-template-columns:1fr 1fr; } .simple-flow:before { display:none; } .simple-step:nth-child(2) { border-right:0; } .simple-step { min-height:230px; border-bottom:1px solid var(--line); } .simple-step:nth-child(3), .simple-step:nth-child(4) { border-bottom:0; } .privacy-grid { column-gap:30px; } }
...
<body>
<div class="shell">
  <nav class="nav" aria-label="Main navigation"><a class="brand" href="/">Student Application <span>AI Helper</span></a><div class="navlinks"><a href="#how">How it works</a><a href="#gates">Quality gates</a><a href="#letter-example">Letter example</a><a href="#privacy">Privacy</a><a href="/sample-prompts">Prompts</a></div></nav>
  <main class="hero">
    <div><div class="kicker">Local-first career coach + MCP</div><h1>Turn your real experience into a stronger application.</h1><p class="lead">Build an evidence-grounded CV and cover letter in your own local folder. You keep control of every file and final decision.</p><div class="actions"><a class="button primary" href="/sample-prompts">Start with a guided prompt</a><a class="button secondary" href="#how">See the process</a></div><p class="connection">AI-agent endpoint: <code>${PUBLIC_MCP_URL}</code>. It provides the kit, a safe structure audit, and optional selected-text feedback.</p></div>
...
<main>
  ...
  <section class="diagram-section" aria-labelledby="protocol-title">
    ...
    <p>The public MCP endpoint is <code>${PUBLIC_MCP_URL}</code>. A compatible AI client uses the Streamable HTTP transport and sends JSON-RPC requests to this one endpoint; it does not receive shell or filesystem access to the candidate computer.</p>
