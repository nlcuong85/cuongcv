...
1. Put your current CV in `candidate/source/` as PDF, DOCX, or HTML.
2. Put a job description or job URL in `jobs/<company-role>/`.
3. For each employer, try to write 10 real bullets in your own words; 15 is even better. These are private source notes, not final CV text.
