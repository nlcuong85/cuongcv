...
if len(sys.argv) < 2 or sys.argv[1] not in {"review-cv", "review-cover", "finalize-cv", "finalize-cover-letter"}:
    raise SystemExit("Use application_quality_loop.py review-cv|review-cover|finalize-cv|finalize-cover-letter with Application SOP arguments.")
